export const faBrandsNameToClass = (name: string) => `fa-brands fa-${name}`
...
// 转为Class方便显示
export const faBrandsClassList = faBrandsNameList.map((i) =>
  faBrandsNameToClass(i)
)
...
// 分成3个一组便于显示
export const faBandsGroupList = splitArray(faBrandsClassList, 3)
