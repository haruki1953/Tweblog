...
} from '@/services/post-control/control-forward/forward-post/dependencies'
...
```ts
// src/services/post-control/control-forward/forward-post/post-platform/pocket-chat/index.ts

export * from './services/forward'
```